...
// comment
const CommentatorInfoSchema = new mongoose.Schema<CommentatorInfoType, Model<CommentatorInfoType>>({
  userId: { type: String, required: true },
  userLogin: { type: String, required: true },
});

export const CommentSchema = new mongoose.Schema<CommentTypeDB, Model<CommentTypeDB>>({
...
// user
const EmailConfirmationSchema = new mongoose.Schema<EmailConfirmation, Model<EmailConfirmation>>({
...
// device
export const DeviceSchema = new mongoose.Schema<DeviceTypeDB, Model<DeviceTypeDB>>({
  userId: { type: String, required: true },
  ip: { type: String, required: true },
  title: { type: String, required: true },
