...
export class AuthService {
  static async createUser({ login, email, password }: IAuthFields): Promise<UserTypeDBWithoutId> {
  ...
  static async checkCredential(loginOrEmail: string, password: string): Promise<ICheckCredential> {
